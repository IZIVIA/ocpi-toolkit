...
import com.izivia.ocpi.toolkit211.modules.locations.domain.LocationPartial
...
class LocationsEmspClient(
    ...
    override suspend fun getEvse(locationId: CiString, evseUid: CiString): Evse? = with(buildTransport()) {
        send(
            HttpRequest(
                method = HttpMethod.GET,
