...
//    val authorization_reference: String,
//    val cdr_location: CdrLocation,
//    val meter_id: String,
//    val currency: String,
//    val tariffs: List<Tariff>,
//    val charging_periods: List<ChargingPeriod>,
//    val signed_data: SignedData,
    val total_cost: Price,
    val total_fixed_cost: Price,
    val total_energy: BigDecimal,
    val total_energy_cost: BigDecimal,
    val total_time: BigDecimal,
    val total_time_cost: Price,
    val total_parking_time: BigDecimal,
    val total_parking_cost: Price,
    val total_reservation_cost: Price,
    val remark: String,
    val invoice_reference_id: String,
    val credit: Boolean,
    val credit_reference_id: String,
