...
data class Location(
    ...
    val id: CiString,
    val publish: Boolean,
    val publish_allowed_to: List<PublishTokenType>? = null,
    ...
    val related_locations: List<AdditionalGeoLocation>? = null,
    val parking_type: ParkingType? = null,
    ...
    val opening_times: Hours? = null,
    val charging_when_closed: Boolean? = null,
