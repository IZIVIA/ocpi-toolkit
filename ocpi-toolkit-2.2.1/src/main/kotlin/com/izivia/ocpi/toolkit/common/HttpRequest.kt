...
suspend fun <T> HttpRequest.respondSearchResult(now: Instant, fn: suspend () -> SearchResult<T>) = wrapResponse {
...
private suspend fun HttpRequest.wrapResponse(fn: suspend () -> HttpResponse): HttpResponse {
