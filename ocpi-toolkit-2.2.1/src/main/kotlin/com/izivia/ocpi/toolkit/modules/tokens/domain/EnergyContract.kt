 ...
 * Charge Point.
 *
 * @property supplier_name Name of the energy supplier for this token.
 * @property contract_id Contract ID at the energy supplier, that belongs to the owner of this token.
 *
 * @constructor
 */
@Partial
