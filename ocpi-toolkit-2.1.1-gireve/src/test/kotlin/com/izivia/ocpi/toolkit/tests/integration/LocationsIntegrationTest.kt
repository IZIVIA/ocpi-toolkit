...
class LocationsIntegrationTest : BaseServerIntegrationTest() {
    ...
    private fun setupCpoServer(locations: List<Location>): Http4kTransportServer {
        ...
        LocationsCpoServer(
            server,
            platformRepository = com.izivia.ocpi.toolkit.samples.common.DummyPlatformCacheRepository(tokenC = tokenC),
    ...
    fun `getLocations test (paginated)`() {
        ...
        val platformRepo = com.izivia.ocpi.toolkit.samples.common.DummyPlatformCacheRepository(tokenC = tokenC).also {
        ...
        expectThat(
            ...
            get { data }
                ...
                .and {
                    get { nextPageUrl }
                        .isEqualTo("${cpoServer.baseUrl}/2.1.1/locations?limit=$limit&offset=${offset + limit}")
                }
        }
        ...
        expectThat(
            ...
            get { data }
                ...
                .and {
                    get { nextPageUrl }
                        .isEqualTo("${cpoServer.baseUrl}/2.1.1/locations?date_to=${dateTo}&limit=$limit&offset=${offset + limit}")
                }
        }
    }
}
