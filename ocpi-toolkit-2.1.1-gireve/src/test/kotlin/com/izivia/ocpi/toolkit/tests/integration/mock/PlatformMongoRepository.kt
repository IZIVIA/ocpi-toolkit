...
class PlatformMongoRepository(
    ...
    override fun saveCredentialsTokenA(platformUrl: String, credentialsTokenA: String): String =
    ...
    override fun getCredentialsTokenB(platformUrl: String): String? = collection
